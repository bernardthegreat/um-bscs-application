  ...
  return {
    ...
    build: {
      ...
      env: {
        ...
        WS_URL: 'wss://apps.uerm.edu.ph:3443/',
      },
      // transpile: false,
    ...
    pwa: {
      ...
      manifest: {
        name: `UM Student Application`,
        short_name: `UM Student Application`,
        description: `A UM Application for Students`,
        display: 'standalone',
